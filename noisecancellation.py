...
with body:
    ...
    with left_column:
        st.markdown("This particular API was created to keep storage & size in mind. With smartphones & high end cameras in everyones hands, people tend to take photos that have huge file size. Most of the times we face issues uploading images to the official websites with limits on images. This API helps you compress all those images to the lowest possible extent and helps you upload them to the required websites. ")
    ...
    #st.write("---")
        ...
        if file_uploader is not None:
            with st.spinner('Compressing...'):
                ...
                audio1 = open("mywav_reduced_noise.wav", "rb")
            with body:
                lbl = "Download audio"
